...
var lineAnim = _gsap.default.to("#lines-1", {
  rotate: 360,
  duration: 175,
  transformOrigin: "center",
  yoyo: true,
...
var lines2Anim = _gsap.default.to("#lines-2", {
  rotate: 360,
  duration: 125,
  scaleX: 1.2,
  transformOrigin: "center",
...
function mouseMoveAnimations(intersection, distancePercent) {
  _gsap.default.to("#iris-shadow", {
    x: intersection[0] + 50 * distancePercent * (intersection[0] / Math.abs(intersection[0])),
    y: intersection[1] > 0 ? intersection[1] * 0.7 : intersection[1] + 50 * distancePercent * (intersection[1] / Math.abs(intersection[1])),
    ease: "slow(0.7, 0.7, false)"
  });

  _gsap.default.to("#reflection-1", {
    x: intersection[0] * 0.15 + 7 * distancePercent * (intersection[0] / Math.abs(intersection[0])),
    y: intersection[1] * 0.15 + 7 * distancePercent * (intersection[1] / Math.abs(intersection[1])),
    ease: "slow(0.7, 0.7, false)"
  });
  ...
  _gsap.default.to("#eye-shadow", {
    x: intersection[0] * 0.12 + 10 * distancePercent * (intersection[0] / Math.abs(intersection[0])),
    y: intersection[1] * 0.12 + 5 * distancePercent * (intersection[1] / Math.abs(intersection[1]))
  });
}
...
function getIntersection(radius, slope, quadrant) {
  var x = Math.sqrt(Math.pow(radius, 2) / (1 + Math.pow(slope, 2)));
  console.log(radius);
...
container.addEventListener("mousemove", function (e) {
  ...
  var distancePercent = percentageOfMaxDistance(calculateDistance(relPos[0], 0, relPos[1], 0));
...
//     }
// }
},{"gsap":"node_modules/gsap/index.js"}],"../../../../../../home/aaroneld/.nvm/versions/node/v12.18.2/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/animated-svg-eye-with-gsap.e31bb0bc.js.map